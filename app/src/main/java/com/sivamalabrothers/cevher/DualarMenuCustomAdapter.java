...
public class DualarMenuCustomAdapter extends RecyclerView.Adapter<DualarMenuCustomAdapter.MyViewHolder> {


    ArrayList<DualarMenuItem> mDataList;
    LayoutInflater inflater;
    int pos;
    Context context;

    public DualarMenuCustomAdapter(Context context, ArrayList<DualarMenuItem> data){
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        DualarMenuItem tiklananItem = mDataList.get(position);
    ...
    public void tiklananMenuCagir(int pos){
        DualarSayfasi dualarSayfasi;
        dualarSayfasi = (DualarSayfasi) context;
        dualarSayfasi.tiklananMenuItem(pos);
    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setData(DualarMenuItem tiklananItem, int position) {
