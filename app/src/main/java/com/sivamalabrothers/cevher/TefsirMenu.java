...
public class TefsirMenu extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tefsir_menu);
        ...
        lay1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(Build.VERSION.SDK_INT>=21 ){
                    ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(TefsirMenu.this);
                    Intent krn = new Intent(getApplicationContext(), Tefsir.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.ayarlar){
            ...
            if(Build.VERSION.SDK_INT>=21 ){
                ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(TefsirMenu.this);
                Intent mMenu = new Intent(getApplicationContext(),TefsirMenu.class);
