...
public class KuranMenu extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kuran_menu);
        ...
        tv_baslik.setText("KUR'AN-I KERİM");
        ...
        sure.setText("SURELER");

        lay1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(Build.VERSION.SDK_INT>=21 ){
                    ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(KuranMenu.this);
                    cuzSure = 0;
                    Intent krn = new Intent(getApplicationContext(), Kuran.class);
                    krn.putExtra("cuzSure", cuzSure);
