...
public class Ikindi extends Fragment implements View.OnClickListener{
    private static final String TAG = "Ikindi";

    private EditText yazi;
    static  float ikdpunto = 14;
