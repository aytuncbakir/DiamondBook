...
public class Tecvid extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tecvid_activity);

        android.support.v7.app.ActionBar actionBar = getSupportActionBar();
        assert actionBar != null;
        actionBar.setTitle("Tecvid");

        // geri butonu
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        // geri butonuna basıldığında çalışır

        arkaplan = findViewById(R.id.tlay);
        ...
        String tecvid []  = getResources().getStringArray(R.array.tecvid);
        arrayLength = tecvid.length;

        ArrayAdapter<String> adapter = new ArrayAdapter<String>(getApplicationContext(),R.layout.cevsen_liste,tecvid);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if(Build.VERSION.SDK_INT>=21 ){
                    ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(Tecvid.this);
                    Intent intent = new Intent(getApplicationContext(),Tecvidsayfasi.class);
                    position  = position - 1;
