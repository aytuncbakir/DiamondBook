...
public class Cevsensayfasi extends AppCompatActivity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cevsen_sayfasi);
    ...
    public void initViews(){
        ...
        kaldigimYer = preferences.getString("cneredeKaldim","Kaldığınız yeri kaydetmediniz.");
        arapcapunto = preferences.getFloat("carapcapunto",24);
        renkMaviMi = preferences.getBoolean("cmaviMi",true);
        normalMi = preferences.getBoolean("cnormalMi",true);
    ...
    public void setArrayLists(  XMLDOMParser xmldomParser){
        String xmlFile = "dualar/cevsen.xml";
        ...
        cvs.setText(arapcasi.get(position));
    ...
    protected void onPause() {
        ...
        editor.putString("cneredeKaldim",kaldigimYer);
        editor.putFloat("carapcapunto",arapcapunto);
        editor.putBoolean("cmaviMi",renkMaviMi);
        editor.putBoolean("cnormalMi",normalMi);
        editor.commit();
    }
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        switch (id){
            ...
            case CUSTOM_DIALOG_ID:
                ...
                kaydetDialog1.setTitle(Html.fromHtml(getResources().getString(R.string.html_cevsensayfasi)));
                kaydetDialog1.setContentView(R.layout.cevsen_ayarlar);
                    ...
                    public void onClick(View view) {
                        ...
                        switch(secilenRadio)
                        {
                            case R.id.meal:
                            {
                                ...
                                cvs.setText(anlami.get(position));
                                break;
                            }
                            case R.id.arapca:
                            {
            ...
            case CUSTOM_DIALOG_ID1:
                ...
                kaydetDialog.setContentView(R.layout.cevsen_kaydet);
