...
public class RisaleMenuCustomAdapter extends RecyclerView.Adapter<RisaleMenuCustomAdapter.MyViewHolder> {


    ArrayList<RisaleMenuItem> mDataList;
    LayoutInflater inflater;
    int pos;
    Context context;

    public RisaleMenuCustomAdapter(Context context, ArrayList<RisaleMenuItem> data){
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        RisaleMenuItem tiklananItem = mDataList.get(position);
    ...
    public void tiklananMenuCagir(int pos){
        RisaleSayfasi risaleSayfasi;
        risaleSayfasi = (RisaleSayfasi) context;
        risaleSayfasi.tiklananMenuItem(pos);
    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setData(RisaleMenuItem tiklananItem, int position) {
