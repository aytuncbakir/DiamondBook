...
public class Yatsi extends Fragment implements View.OnClickListener{
    private static final String TAG = "Yatsi";

    private Button btnTEST;
    private EditText yazi;
    static float ytspunto = 14;
